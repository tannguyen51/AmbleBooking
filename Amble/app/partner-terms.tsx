...
const TERMS = [
  "Người dùng và đối tác khi sử dụng nền tảng Munch Map đồng ý tuân thủ toàn bộ điều khoản và chính sách được quy định trên hệ thống.",
  ...
  "Munch Map có quyền tạm ngưng, giới hạn hoặc chấm dứt quyền truy cập đối với tài khoản có dấu hiệu gian lận, lạm dụng hệ thống hoặc vi phạm điều khoản sử dụng.",
  ...
  "Munch Map thu thập và xử lý dữ liệu người dùng nhằm mục đích vận hành hệ thống, hỗ trợ đặt bàn và nâng cao trải nghiệm sử dụng dịch vụ.",
  ...
  "Người dùng và đối tác không được sử dụng, sao chép hoặc khai thác dữ liệu phát sinh từ hệ thống Munch Map cho mục đích thương mại khi chưa có sự cho phép bằng văn bản.",
  "Munch Map không chịu trách nhiệm đối với các gián đoạn dịch vụ, thay đổi thông tin hoặc sự cố phát sinh từ phía đối tác nhà hàng ngoài phạm vi kiểm soát của hệ thống.",
  "Munch Map có quyền cập nhật hoặc điều chỉnh điều khoản sử dụng vào bất kỳ thời điểm nào nhằm phù hợp với hoạt động vận hành của nền tảng.",
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.intro}>
          Vui lòng đọc kỹ trước khi sử dụng hệ thống quản lý nhà hàng trên Munch
          Map.
        </Text>
